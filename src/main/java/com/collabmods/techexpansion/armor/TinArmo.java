...
public class TinArmo extends ItemArmor{

	public static String textureName;
	public static String extrapath;
	
	public TinArmo(String unlocalizedName, ArmorMaterial material, String textureName, int type, String itemTextureName, String extrapath) {
