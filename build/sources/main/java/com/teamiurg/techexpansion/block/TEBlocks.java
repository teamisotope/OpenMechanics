...
public class TEBlocks {
	...
	/* ores */
	public static Block copper_ore = new TEBlock(Material.IRON, "copper_ore", "copper_ore", TechExpansion.tab_techExpansion, 3.0f, 15.0f, SoundType.STONE, 0, 0.0f, "pickaxe", 1, false);
	public static Block aluminum_ore = new TEBlock(Material.IRON, "aluminum_ore", "aluminum_ore", TechExpansion.tab_techExpansion, 3.0f, 15.0f, SoundType.STONE, 0, 0.0f, "pickaxe", 1, false);
	public static Block tin_ore = new TEBlock(Material.IRON, "tin_ore", "tin_ore", TechExpansion.tab_techExpansion, 2.5f, 13.0f, SoundType.STONE, 0, 0.0f, "pickaxe", 1, false);
	/* blocks */
	public static Block copper_block = new TEBlock(Material.IRON, "copper_block", "copper_block", TechExpansion.tab_techExpansion, 3.5f, 17.0f, SoundType.METAL, 0, 0.0f, "pickaxe", 1, false);
	public static Block aluminum_block = new TEBlock(Material.IRON, "aluminum_block", "aluminum_block", TechExpansion.tab_techExpansion, 3.5f, 17.0f, SoundType.METAL,0 ,0.0f, "pickaxe", 1, false);
	public static Block tin_block = new TEBlock(Material.IRON, "tin_block", "tin_block", TechExpansion.tab_techExpansion, 3.0f, 15.0f, SoundType.METAL, 0, 0.0f, "pickaxe", 1, false);
